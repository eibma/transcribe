...
class PreferencesTranscribeDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesTranscribeDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesTranscribeDialog object.
        """
        builder = get_builder('PreferencesTranscribeDialog')
        new_object = builder.get_object("preferences_transcribe_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesTranscribeDialog object with it in order to
        finish initializing the start of the new PerferencesTranscribeDialog
        instance.
...
if __name__ == "__main__":
    dialog = PreferencesTranscribeDialog()
    dialog.show()
    gtk.main()
